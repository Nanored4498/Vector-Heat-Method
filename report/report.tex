...
\begin{document}
	...
	\begin{center}
		...
		\end{tikzpicture}
	\end{center}
	Ainsi en reprenant le Laplacien cotangent $L$ pour un maillage triangulaire (vu en TP), on obtient le Laplacien de connexion $L^\nabla$ via :
	$$ L_{ij}^\nabla = \syst{ll}{
		L_{ij} & \text{Si } i = j \\
